OC.L10N.register(
    ...
    "<strong>Error!</strong> Could not generate a preview of this file.<br>Please go to the next slide while we remove this image from the slideshow" : "<strong>오류!</strong> 이 파일의 미리보기를 생성 할 수 없습니다.<br>슬라이드 쇼에서 이 이미지를 제거하는 동안 다음 슬라이드로 이동하십시오.",
    "Next" : "다음",
    "Play" : "재생",
    "Pause" : "일시 정지",
    "Previous" : "이전",
    ...
    "Email sent" : "이메일 발송됨",
    "Warning" : "경고",
    "Add to Compression.ai" : "Compression.ai에 추가",
    ...
    "For more information, please contact your friendly Compression.ai administrator." : "더 많은 정보를 확인하려면 Compression.ai 관리자에게 연락하십시오.",
