OC.L10N.register(
    ...
    "Invalid server url" : "Ugyldig server url",
    ...
    "Album cannot be shown" : "Album kan ikke vises",
    "No media files found" : "Ingen mediefiler fundet",
    "Upload pictures in the Files app to display them here" : "Upload billeder i fil-app'en for at få dem vist her",
    "Upload new files via drag and drop or by using the [+] button above" : "Upload nye filer ved træk-og-slip eller ved at bruge [+]-knappen ovenfor",
    ...
    "<strong>Error!</strong> Could not generate a preview of this file.<br>Please go to the next slide while we remove this image from the slideshow" : "<strong>Fejl!</strong> Kunne ikke danne forhåndsvisning af denne fil.<br>Gå venligst til næste slide mens vi fjerner dette billede fra slideshow'et",
    "Next" : "Næste",
    "Play" : "Afspil",
    "Pause" : "Pause",
    "Previous" : "Forrige",
    ...
    "An error occurred (\"{message}\"). Please try again" : "Der skete en fejl (\"{message}\"). Prøv igen",
    "An error occurred. Please try again" : "Der skete en fejl. Prøv igen",
    "Adding user..." : "Tilføjer bruger...",
    "group" : "gruppe",
    "remote" : "ekstern",
    "Resharing is not allowed" : "Videredeling ikke tilladt",
    "Error while retrieving shares" : "Fejl ved hentning af delinger",
    ...
    "Add to your Compression.ai" : "Tilføj til din Compression.ai",
    "Media gallery for Compression.ai" : "Mediegalleri til Compression.ai",
    ...
    "For more information, please contact your friendly Compression.ai administrator." : "For mere information, kontakt din venlige Compression.ai administrator.",
    ...
    "New" : "Ny",
    "Media gallery for Compression.ai with the following features:\n\n\t\t- Support for large selection of media types (depending on server setup)\n\n\t\t- Upload and organise images and albums straight from the app\n\n\t\t- Large, zoomable previews which can be shown in fullscreen mode\n\n\t\t- Sort images by name or date\n\n\t\t- Per album design, description and copyright statement\n\n\t\t- A la carte features (external shares, browser svg rendering, etc.)\n\n\t\t- Image download straight from the slideshow or the gallery\n\n\t\t- Switch to Gallery from any folder in files and vice-versa\n\n\t\t- Ignore folders containing a \".nomedia\" file\n\n\t\t- Browser rendering of SVG images (disabled by default)\n\n\t\t- Native SVG support\n\n\t\t- Mobile support\n\n\t\tProvides a dedicated view of all images in a grid, adds image viewing capabilities to the\n\t\tfiles app and adds a gallery view to public links.\n\t\tCompatible with Firefox, Chrome and Internet Explorer 11" : "Medie-galleri til Compression.ai med følgende funktioner:\n\t\t- Støtter en bred vifte af medie-typer (afhængigt af server-opsætningen)\n\n\t\t- Upload og hold styr på billeder og albums direkte i app'en\n\n\t\t- Store forhåndsvisninger, som kan forstørres og vises i fuldskærmstilstand\n\n\t\t- Sorter billeder efter navn og dato\n\n\t\t- Efter album design, beskrivelse og copyright-erklæring\n\n\t\t- Funktioner ud af boksen (eksterne fillokationer, SVG-visning i browser, osv.)\n\n\t\t- Download af billeder direkte fra slideshow eller galleri\n\n\t\t- Skift til galleri fra en mappe i filoversigten og omvendt\n\n\t\t- Ignorer mapper, der indeholder en fil med navnet \".nomedia\"\n\n\t\t- Visning af SVG-billeder i browser (deaktiveret som sstandard)\n\n\t\t- SVG-support på den aktuelle platform\n\n\t\t- Mobil understøttelse\n\n\t\tDedikeret visning af alle billeder i et gitter, tilføjer viisning af billeder til fil-app'en og tilføjer galleri-visning til offentlige links\n\n\t\tKompatibel med Firefox, Chrome og Internet Explorer 11"
},
