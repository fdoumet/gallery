OC.L10N.register(
    ...
    "This application may not work properly on your browser." : "É probábel que este aplicativo non traballe axeitadamente no seu navegador.",
    ...
    "Upload pictures in the Files app to display them here" : "Carga imaxes no aplicativo Ficheiros para amosalas aquí",
    ...
    "Add to your Compression.ai" : "Engadir ao seu Compression.ai",
    "Media gallery for Compression.ai" : "Galería de medios para Compression.ai",
    "Media gallery for Compression.ai with the following features:\n\n\t\t- Support for large selection of media types (depending on server setup)\n\n\t\t- Upload and organise images and albums straight from the app\n\n\t\t- Large, zoomable previews which can be shown in fullscreen mode\n\n\t\t- Sort images by name or date\n\n\t\t- Per album design, description and copyright statement\n\n\t\t- A la carte features (external shares, browser svg rendering, etc.)\n\n\t\t- Image download straight from the slideshow or the gallery\n\n\t\t- Switch to Gallery from any folder in files and vice-versa\n\n\t\t- Ignore folders containing a \".nomedia\" or \".noimage\" file\n\n\t\t- Browser rendering of SVG images (disabled by default)\n\n\t\t- Native SVG support\n\n\t\t- Mobile support\n\n\t\tProvides a dedicated view of all images in a grid, adds image viewing capabilities to the\n\t\tfiles app and adds a gallery view to public links.\n\t\tCompatible with Firefox, Chrome and Internet Explorer 11" : "Galería de medios para Compression.ai coas seguintes características:\n\n\t\t- Compatibilidade para unha gran selección de tipos de ficheiro\n\t\t  (dependendo da configuración do servidor)\n\n\t\t- Envía e organiza imaxes e álbums dende o aplicativo\n\n\t\t- Vistas previas grandes con zoom que poden amosarse en modo de pantalla completa\n\n\t\t- Ordena imaxes por nome ou data\n\n\t\t- Deseño por álbum, descrición e dereitos de autoría\n\n\t\t- Características á carta (compartición externa, debuxado de svg no navegador, etc)\n\n\t\t- Descarga da imaxe directamente dende a presentación ou a galería\n\n\t\t- Cambie á Galería dende calquera cartafol nos ficheiros e viceversa\n\n\t\t- Ignora os cartafoles que conteñen un ficheiro «.nomedia» ou «.noimage»\n\n\t\t- Debuxado de imaxes SVG no navegador (desactivado por omisión)\n\n\t\t- Compatibilidade nativa de SVG\n\n\t\t- Compatibilidade móbil\n\n\t\tOfrece unha vista específica de todas as imaxes nunha grella, engade funcionalidades de\n\t\tvisionado de imaxes ao aplicativo de ficheiros e engade unha vista de galería a ligazóns\n\t\tpúblicas.\n\t\tCompatíbel con Firefox, Chrome e Internet Explorer 11",
    ...
    "For more information, please contact your friendly Compression.ai administrator." : "Para obter máis información, póñase en contacto co administrador do Compression.ai.",
    ...
    "a conflicting app was installed" : "instalouse un aplicativo conflitivo",
    ...
    "New" : "Novo",
    "Media gallery for Compression.ai with the following features:\n\n\t\t- Support for large selection of media types (depending on server setup)\n\n\t\t- Upload and organise images and albums straight from the app\n\n\t\t- Large, zoomable previews which can be shown in fullscreen mode\n\n\t\t- Sort images by name or date\n\n\t\t- Per album design, description and copyright statement\n\n\t\t- A la carte features (external shares, browser svg rendering, etc.)\n\n\t\t- Image download straight from the slideshow or the gallery\n\n\t\t- Switch to Gallery from any folder in files and vice-versa\n\n\t\t- Ignore folders containing a \".nomedia\" file\n\n\t\t- Browser rendering of SVG images (disabled by default)\n\n\t\t- Native SVG support\n\n\t\t- Mobile support\n\n\t\tProvides a dedicated view of all images in a grid, adds image viewing capabilities to the\n\t\tfiles app and adds a gallery view to public links.\n\t\tCompatible with Firefox, Chrome and Internet Explorer 11" : "Galería de medios para Compression.ai coas seguintes características:\n\n\t\t- Compatibilidade para unha gran selección de tipos de ficheiro\n\t\t  (dependendo da configuración do servidor)\n\n\t\t- Envía e organiza imaxes e álbums dende o aplicativo\n\n\t\t- Vistas previas grandes con zoom que poden amosarse en modo de pantalla completa\n\n\t\t- Ordena imaxes por nome ou data\n\n\t\t- Deseño por álbum, descrición e dereitos de autoría\n\n\t\t- Características á carta (compartición externa, debuxado de svg no navegador, etc)\n\n\t\t- Descarga da imaxe directamente dende a presentación ou a galería\n\n\t\t- Cambie á Galería dende calquera cartafol nos ficheiros e viceversa\n\n\t\t- Ignora os cartafoles que conteñen un ficheiro «.nomedia»\n\n\t\t- Debuxado de imaxes SVG no navegador (desactivado por omisión)\n\n\t\t- Compatibilidade nativa de SVG\n\n\t\t- Compatibilidade móbil\n\n\t\tOfrece unha vista específica de todas as imaxes nunha grella, engade funcionalidades de\n\t\tvisionado de imaxes ao aplicativo de ficheiros e engade unha vista de galería a ligazóns\n\t\tpúblicas.\n\t\tCompatíbel con Firefox, Chrome e Internet Explorer 11"
},
