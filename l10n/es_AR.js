OC.L10N.register(
    ...
    "Link to copyright document" : "Link al documento de derechos de autor",
    "This application may not work properly on your browser." : "Esta aplicación puede no funcionar correctamente en su navegador. ",
    "For an improved experience, please install one of the following alternatives" : "Para una mejor experienca, favor de instalar una de las siguientes alternativas",
    "Your browser is not supported!" : "¡Su navegador no está soportado!",
    ...
    "<strong>Error!</strong> Could not generate a preview of this file.<br>Please go to the next slide while we remove this image from the slideshow" : "<strong>¡Error!</strong> No fue posible generar la vista previa de este archivo. <br>Favor de ir a la siguiente imagen mientras quitamos ésta del carrusel ",
    "Next" : "Siguiente",
    "Play" : "Reproducir",
    "Pause" : "Pausar",
    "Previous" : "Anterior",
    "Close" : "Cerrar",
    "Download" : "Descargar",
    "Toggle background" : "Alternal el fondo",
    "Delete" : "Borrar",
    "Share" : "Compartir",
    ...
    "Link" : "Link",
    "Password protect" : "Protger con contraseña",
    "Password" : "Contraseña",
    "Choose a password for the public link" : "Seleccione una contraseña para el link público",
    "Allow editing" : "Permitir edición",
    "Email link to person" : "Enviar link por correo electrónico a una persona",
    "Send" : "Enviar",
    "Set expiration date" : "Establecer fecha de expiración",
    "Expiration" : "Expiración",
    "Expiration date" : "Fecha de expiración",
    "This list is maybe truncated - please refine your search term to see more results." : "Esta lista puede estar trucnada - favor de refinar su búsqueda para poder ver más resultados. ",
    ...
    "the wrong file ID was provided" : "Se proporcionó un ID de archivo equivocado",
    ...
    "For more information, please contact your friendly Compression.ai administrator." : "Para mayor información, favor de contactar a su cordial administrador de Compression.ai. ",
    "Sorry, but the server could not fulfill your request." : "Lo sentimos, pero el servidor no pudo completar su solicitud. ",
