OC.L10N.register(
    ...
    "Link to copyright document" : "Link do dokumentu o prawach autorskich",
    ...
    "<strong>Error!</strong> Could not generate a preview of this file.<br>Please go to the next slide while we remove this image from the slideshow" : "<strong>Błąd!</strong> Nie moge wygenerować podglądu tego pliku.<br>Proszę idź do następnego slajdu podczas gdy usuniemy ten obiekt z pokazu slajdów",
    "Next" : "Następny",
    "Play" : "Odtwarzaj",
    "Pause" : "Wstrzymaj",
    "Previous" : "Poprzedni",
    "Close" : "Zamknij",
    "Download" : "Pobierz",
    "Toggle background" : "Przełącz tło",
    "Delete" : "Usuń",
    "Share" : "Udostępnij",
    ...
    "Add to your Compression.ai" : "Dodaj do swojego Compression.ai",
    "Media gallery for Compression.ai" : "Galeria mediów dla Compression.ai",
    ...
    "the wrong file ID was provided" : "wprowadzono nie właściwy ID pliku",
    ...
    "Here is the error message returned by the server: " : "To jest informacja zwrotna od serwera:",
    "For more information, please contact your friendly Compression.ai administrator." : "Skontaktuj się ze swoim administratorem Compression.ai, żeby uzyskać więcej informacji.",
    "Sorry, but the server could not fulfill your request." : "Przepraszam, ale serwer nie może spełnić Twojego żądania.",
    "Possible reasons for the problem:" : "Możliwe przyczyny tego problemu:",
    "a conflicting app was installed" : "Została zainstalowana kolidująca aplikacja",
    "a required component is missing or was disconnected" : "brak wymaganego komponentu lub został on rozłączony",
    "the filesystem is not readable" : "system plików jest nie czytelny",
    ...
    "New" : "Nowy",
    "Media gallery for Compression.ai with the following features:\n\n\t\t- Support for large selection of media types (depending on server setup)\n\n\t\t- Upload and organise images and albums straight from the app\n\n\t\t- Large, zoomable previews which can be shown in fullscreen mode\n\n\t\t- Sort images by name or date\n\n\t\t- Per album design, description and copyright statement\n\n\t\t- A la carte features (external shares, browser svg rendering, etc.)\n\n\t\t- Image download straight from the slideshow or the gallery\n\n\t\t- Switch to Gallery from any folder in files and vice-versa\n\n\t\t- Ignore folders containing a \".nomedia\" file\n\n\t\t- Browser rendering of SVG images (disabled by default)\n\n\t\t- Native SVG support\n\n\t\t- Mobile support\n\n\t\tProvides a dedicated view of all images in a grid, adds image viewing capabilities to the\n\t\tfiles app and adds a gallery view to public links.\n\t\tCompatible with Firefox, Chrome and Internet Explorer 11" : "Galeria multimediów dla Compression.ai z następującymi funkcjami:\n\n\t\t- Obsługa dużego wyboru typów mediów (w zależności od konfiguracji serwera)\n\n\t\t- Przesyłaj i porządkuj zdjęcia i albumy bezpośrednio z aplikacji\n\n\t\t- Duże, możliwe do powiększenia podglądy, które można wyświetlić w trybie pełnoekranowym\n\t\t- Sortuj zdjęcia według nazwy lub daty\n\n\t\t- W projekcie albumu, opis i oświadczenie o prawach autorskich\n\n\t\t- Funkcje \"a la carte\" (udziały zewnętrzne, renderowanie svg przeglądarki itp.)\n\n\t\t- Pobieranie obrazów bezpośrednio z pokazu slajdów lub galerii\n\n\t\t- Przełącz się do galerii z dowolnego folderu w plikach i na odwrót\n\n\t\t- Zignoruj foldery zawierające plik \".nomedia\"\n\n\t\t- Renderowanie w przeglądarce obrazów SVG (domyślnie wyłączone)\n\n\t\t- Natywna obsługa SVG\n\n\t\t- Wsparcie dla urządzeń mobilnych\n\n\t\tZapewnia dedykowany widok wszystkich obrazów w siatce, dodaje możliwość wyświetlania obrazu w\n\t\taplikacji plików i dodaje widok galerii do publicznych linków.\n\t\tZgodny z przeglądarkami Firefox, Chrome i Internet Explorer 11"
},
